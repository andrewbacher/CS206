...
class MOTOR:
    ...
    def Set_Value(self, robot, desiredAngle):
        pyrosim.Set_Motor_For_Joint(bodyIndex=robot, jointName=self.jointName, controlMode=simulation.p.POSITION_CONTROL, targetPosition=desiredAngle, maxForce=c.maxForce)